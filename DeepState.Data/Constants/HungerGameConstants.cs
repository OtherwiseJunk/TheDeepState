...
namespace DeepState.Data.Constants
{
	public static class HungerGameConstants
	{
		...
		public const double CostOfAdmission = 2000;
		...
		public static List<string> Weapons = new List<string>
		{
			...
			"the Master Sword.",
			"a Keyblade.",
			"a Big Fucking (Mini)Gun.",
			"a Big Fucking Gun (9000).",
			"a Big Fucking Gun (uwu).",
			"the Mega-Buster.",
			"the Blades of Chaos.",
			"a Frying Pan.",
			...
			"a Faulty O-Ring (sabotaged).",
			"a Faulty O-Ring (unmodified).",
			...
			"a Big Iron (worn on their hip).",
			"a Big Iron (and unwrinkled clothes).",
			"a Wooden Steak.",
			"a Wooden Stake.",
			"a Meaty Steak.",
			"their MIND !!!!!",
			...
			"a Death Note. Cause of Death? Serbu RN-50 malfunction.",
			"ONE PUNCH.",
			"a MIGHTY Kamehameha.",
			"a Clank of Tanks.",
			"a Ukelele.",
