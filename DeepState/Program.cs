...
namespace DeepState
{
	public class Program
	{
		...
		{			
			...
			JobManager.AddJob(() => HungerGameUtilities.DailyEvent((HungerGamesService)_services.GetService(typeof(HungerGamesService)), _client), s => s.ToRunEvery(1).Days().At(13, 0));
		}
