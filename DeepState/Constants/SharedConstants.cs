...
namespace DeepState.Constants
{
	public class SharedConstants
	{
		...
		public static string ERegex = "[e,е,ô,ó,o,é,è,ė,ê,ë,æ,@,ò,ö,ě,ĕ,*,ē,ẽ,ę,ȩ,:,ɇ,ế,ề,ḗ,ḕ,ễ,ḝ,ẻ,ȅ,ȇ,ể,ẹ,ḙ,ḛ,ệ,3,a,e,*,ô,ó,o,é,е,è,ė,a,ê,ë,@,ò,ö,ě,ĕ,ē,ẽ,ę,ȩ,ɇ,ế,ề,ḗ,ḕ,ễ,ḝ,ẻ,ȅ,:,3,ȇ,ể,ẹ,ḙ,in,ḛ,ệ]";
		public static string PreggersDetector = $"[p,ρ,𝖯,𝐩,p,P,𝞺,𝚙,ｐ,𝞀,ß,:,*,р,🅱️]+[r,®️,:]+{ERegex}+[g,ġ,8,6,9,ℊ,:,𝒈,𝗀,𝕘,*]+{ERegex}*[r,:,r,*,®️,]+s*";
