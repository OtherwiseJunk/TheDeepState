...
namespace DeepState.Constants
{
	public class SharedConstants
	{
		...
		public static string FlaggedTwitterUserDetector = @"https*://[c.]*[fx]*[vx]*twitter.com/[realDonaldTrump,elonmusk,realdonaldtrump,ElonMusk]+/status/\d+[?]*.+";
		public static string TwitterStatusDetector = @"https*://[c.]*[fx]*[vx]*twitter.com/.+/status/\d+[?]*.+";
		#endregion
