...
namespace DeepState.Constants
{
	public class SharedConstants
	{
		...
		public static string G = "[gġ8🇬6🥚9ℊ:;𝒈𝗀*𝕘𝓰🇬]";
		public static string E = "[eе🇪ô𝓮🇪óéɚèėᲕęê£ëæěĕẽęȩ:ɛ̃;ɇếềεḗḕễḝẻȅȇểẹḙḛệ@òɘöē3ʒϵЗĒ]";
		...
		public static string PreggizleDetector = $"{P}+{R}+{E}*{G}+izle";
