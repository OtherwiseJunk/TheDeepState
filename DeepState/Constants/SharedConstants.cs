...
namespace DeepState.Constants
{
	public class SharedConstants
	{
		...
		public static string G = "[g,ġ,8,6,9,ℊ,:,𝒈,𝗀,𝕘,*]";
		public static string E = "[e,е,ô,ó,é,è,ė,ê,ë,æ,ě,ĕ,ẽ,ę,ȩ,:,ɇ,ế,ề,ḗ,ḕ,ễ,ḝ,ẻ,ȅ,ȇ,ể,ẹ,ḙ,ḛ,ệ,@,ò,ö,ē,3,ϵ,З]";
		public static string P = "[p,ρ,𝖯,𝐩,p,P,𝞺,𝚙,ｐ,𝞀,ß,:,р,🅱]";
		public static string R = "[r,r,®️,:,]";
